...
public class BrandMapper implements Mapper<Brand, BrandDto> {
    ...
    @Override
    public void updateFromDto(final BrandDto dto, final Brand persistable) throws IllegalMappingOperationException {
        throw new IllegalMappingOperationException("Unsupported mapping with update of BrandDto to Brand");
    }
}
